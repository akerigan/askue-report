...
public class AbstractTableModelExample extends JPanel {
    private ArrayListModel<DisplayTechnology> arrayListModel;
    ...
    public AbstractTableModelExample() {
        ...
        this.arrayListModel = new ArrayListModel<DisplayTechnology>();
        ...
        SelectionInList<DisplayTechnology> selectionInList = new SelectionInList<DisplayTechnology>((ListModel) this.arrayListModel);
